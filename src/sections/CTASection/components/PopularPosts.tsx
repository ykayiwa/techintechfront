export const PopularPosts = () => {
  return (
    <div className="relative text-base box-border caret-transparent gap-x-5 flex flex-col flex-wrap leading-[27.2px] min-h-[auto] gap-y-5 w-full pt-5 px-5 md:text-[17px] md:flex-nowrap md:leading-[28.9px] md:w-6/12 md:pl-[50px] md:pr-2.5 md:pt-0">
            ...
            <div className="text-base box-border caret-transparent flex grow flex-wrap leading-[27.2px] gap-y-[15px] md:text-[17px] md:leading-[28.9px] md:gap-y-5">
              <div className="relative text-base box-border caret-transparent flex basis-full flex-row-reverse leading-[27.2px] min-h-[auto] min-w-[auto] w-full pb-[15px] md:text-[17px] md:leading-[28.9px] md:pb-5 before:accent-auto before:box-border before:caret-transparent before:text-black before:block before:text-base before:not-italic before:normal-nums before:font-normal before:h-px before:tracking-[normal] before:leading-[27.2px] before:list-outside before:list-disc before:max-w-full before:pointer-events-none before:absolute before:text-start before:no-underline before:indent-[0px] before:normal-case before:visible before:border-b before:border-separate before:bottom-0 before:inset-x-0 before:font-arial before:md:text-[17px] before:md:leading-[28.9px]">
                <div className="relative text-base box-border caret-transparent shrink-0 leading-[27.2px] max-w-full min-h-[auto] min-w-[auto] w-[100px] ml-5 md:text-[17px] md:leading-[28.9px] md:w-[180px]">
                  <div className="relative text-base box-border caret-transparent leading-[27.2px] overflow-hidden pb-[75%] md:text-[17px] md:leading-[28.9px]">
                    <a
                      href="https://foxiz.io/marketminds/blog/forging-authentic-connections-that-resonate-with-consumers/"
                ...
                <div className="relative text-base box-border caret-transparent grow leading-[27.2px] min-h-[auto] min-w-[auto] md:text-[17px] md:leading-[28.9px]">
                  <h2 className="relative text-[19px] font-bold box-border caret-transparent tracking-[-0.55879px] leading-[24.7px] break-words mb-[7px] font-plus_jakarta_sans md:text-[28px] md:tracking-[-0.82348px] md:leading-[35px] before:accent-auto before:box-border before:caret-transparent before:text-lime-300/50 before:block before:text-[80px] before:not-italic before:normal-nums before:font-bold before:tracking-[-2.3528px] before:leading-[80px] before:list-outside before:list-disc before:break-words before:pointer-events-none before:absolute before:text-start before:no-underline before:indent-[0px] before:normal-case before:visible before:border-separate before:left-0 before:top-0 before:font-plus_jakarta_sans before:md:text-[150px] before:md:tracking-[-4.4115px] before:md:leading-[150px]">
                    <a
                      href="https://foxiz.io/marketminds/blog/forging-authentic-connections-that-resonate-with-consumers/"
                      className="relative text-[19px] bg-no-repeat bg-size-[0%_100%] box-border caret-transparent tracking-[-0.55879px] leading-[24.7px] break-words underline-offset-[1.9px] bg-[position:0px_100%] md:text-[28px] md:tracking-[-0.82348px] md:leading-[35px] md:underline-offset-[2.8px]"
                    >
                      {" "}
                      Forging Authentic Connections that Resonate with
                      Consumers{" "}
                    </a>
                  </h2>
                  <div className="relative text-base box-border caret-transparent leading-[27.2px] md:text-[17px] md:leading-[28.9px]">
              ...
              <div className="relative text-base box-border caret-transparent flex basis-full flex-row-reverse leading-[27.2px] min-h-[auto] min-w-[auto] w-full pb-[15px] md:text-[17px] md:leading-[28.9px] md:pb-5 before:accent-auto before:box-border before:caret-transparent before:text-black before:block before:text-base before:not-italic before:normal-nums before:font-normal before:h-px before:tracking-[normal] before:leading-[27.2px] before:list-outside before:list-disc before:max-w-full before:pointer-events-none before:absolute before:text-start before:no-underline before:indent-[0px] before:normal-case before:visible before:border-b before:border-separate before:bottom-0 before:inset-x-0 before:font-arial before:md:text-[17px] before:md:leading-[28.9px]">
                <div className="relative text-base box-border caret-transparent shrink-0 leading-[27.2px] max-w-full min-h-[auto] min-w-[auto] w-[100px] ml-5 md:text-[17px] md:leading-[28.9px] md:w-[180px]">
                  <div className="relative text-base box-border caret-transparent leading-[27.2px] overflow-hidden pb-[75%] md:text-[17px] md:leading-[28.9px]">
                    <a
                      href="https://foxiz.io/marketminds/blog/fashionable-summer-accessories-to-dress-up-your-travel-look/"
                ...
                <div className="relative text-base box-border caret-transparent grow leading-[27.2px] min-h-[auto] min-w-[auto] md:text-[17px] md:leading-[28.9px]">
                  <h2 className="relative text-[19px] font-bold box-border caret-transparent tracking-[-0.55879px] leading-[24.7px] break-words mb-[7px] font-plus_jakarta_sans md:text-[28px] md:tracking-[-0.82348px] md:leading-[35px] before:accent-auto before:box-border before:caret-transparent before:text-lime-300/50 before:block before:text-[80px] before:not-italic before:normal-nums before:font-bold before:tracking-[-2.3528px] before:leading-[80px] before:list-outside before:list-disc before:break-words before:pointer-events-none before:absolute before:text-start before:no-underline before:indent-[0px] before:normal-case before:visible before:border-separate before:left-0 before:top-0 before:font-plus_jakarta_sans before:md:text-[150px] before:md:tracking-[-4.4115px] before:md:leading-[150px]">
                    ...
                    >
                      {" "}
                      Fashionable Summer Accessories to Dress Up Your Travel
                      Look{" "}
                    </a>
                  </h2>
                  <div className="relative text-base box-border caret-transparent leading-[27.2px] md:text-[17px] md:leading-[28.9px]">
              ...
              <div className="relative text-base box-border caret-transparent flex basis-full flex-row-reverse leading-[27.2px] min-h-[auto] min-w-[auto] w-full md:text-[17px] md:leading-[28.9px] before:accent-auto before:box-border before:caret-transparent before:text-black before:block before:text-base before:not-italic before:normal-nums before:font-normal before:h-px before:tracking-[normal] before:leading-[27.2px] before:list-outside before:list-disc before:max-w-full before:pointer-events-none before:absolute before:text-start before:no-underline before:indent-[0px] before:normal-case before:visible before:border-separate before:bottom-0 before:inset-x-0 before:font-arial before:md:text-[17px] before:md:leading-[28.9px]">
                <div className="relative text-base box-border caret-transparent shrink-0 leading-[27.2px] max-w-full min-h-[auto] min-w-[auto] w-[100px] ml-5 md:text-[17px] md:leading-[28.9px] md:w-[180px]">
                  <div className="relative text-base box-border caret-transparent leading-[27.2px] overflow-hidden pb-[75%] md:text-[17px] md:leading-[28.9px]">
                    <a
                      href="https://foxiz.io/marketminds/blog/david-is-tommy-wiseau-in-the-first-teaser-for-the-amazon-warrior/"
                ...
                <div className="relative text-base box-border caret-transparent grow leading-[27.2px] min-h-[auto] min-w-[auto] md:text-[17px] md:leading-[28.9px]">
                  <h2 className="relative text-[19px] font-bold box-border caret-transparent tracking-[-0.55879px] leading-[24.7px] break-words mb-[7px] font-plus_jakarta_sans md:text-[28px] md:tracking-[-0.82348px] md:leading-[35px] before:accent-auto before:box-border before:caret-transparent before:text-lime-300/50 before:block before:text-[80px] before:not-italic before:normal-nums before:font-bold before:tracking-[-2.3528px] before:leading-[80px] before:list-outside before:list-disc before:break-words before:pointer-events-none before:absolute before:text-start before:no-underline before:indent-[0px] before:normal-case before:visible before:border-separate before:left-0 before:top-0 before:font-plus_jakarta_sans before:md:text-[150px] before:md:tracking-[-4.4115px] before:md:leading-[150px]">
                    ...
                    >
                      {" "}
                      David is Tommy Wiseau in the First Teaser for The Amazon
                      Warrior{" "}
                    </a>
                  </h2>
                  <div className="relative text-base box-border caret-transparent leading-[27.2px] md:text-[17px] md:leading-[28.9px]">
