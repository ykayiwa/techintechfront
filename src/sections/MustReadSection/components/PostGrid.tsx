              ...
              <div className="relative text-base bg-slate-950 box-border caret-transparent h-full leading-[27.2px] pb-[30px] md:text-[17px] md:leading-[28.9px]">
                <div className="relative text-base box-border caret-transparent leading-[27.2px] max-w-full z-10 mb-2.5 md:text-[17px] md:leading-[28.9px] md:mb-3">
                  <div className="relative text-base box-border caret-transparent leading-[27.2px] overflow-hidden pb-[100%] md:text-[17px] md:leading-[28.9px]">
                    <a
                      href="https://foxiz.io/marketminds/blog/18-top-fall-fashion-trends-from-new-york-fashion/"
                ...
                <h2 className="text-[19px] font-bold box-border caret-transparent tracking-[-0.55879px] leading-[24.7px] break-words mb-2.5 mx-[25px] font-plus_jakarta_sans md:text-[28px] md:tracking-[-0.82348px] md:leading-[35px] md:mb-3">
                  <a
                    href="https://foxiz.io/marketminds/blog/18-top-fall-fashion-trends-from-new-york-fashion/"
                    className="relative text-[19px] bg-no-repeat bg-size-[0%_100%] box-border caret-transparent tracking-[-0.55879px] leading-[24.7px] break-words underline-offset-[1.9px] bg-[position:0px_100%] md:text-[28px] md:tracking-[-0.82348px] md:leading-[35px] md:underline-offset-[2.8px] hover:text-black hover:border-black hover:bg-lime-300 transition-colors duration-200"
                  >
                    {" "}
            ...
            <div className="relative text-base box-border caret-transparent basis-full leading-[27.2px] max-w-[290px] min-h-[auto] min-w-[290px] w-full px-px md:text-[17px] md:basis-3/12 md:leading-[28.9px] md:max-w-none md:min-w-[auto] md:w-3/12">
              <div className="relative text-base bg-slate-950 box-border caret-transparent h-full leading-[27.2px] pb-[30px] md:text-[17px] md:leading-[28.9px]">
                <div className="relative text-base box-border caret-transparent leading-[27.2px] max-w-full z-10 mb-2.5 md:text-[17px] md:leading-[28.9px] md:mb-3">
                  <div className="relative text-base box-border caret-transparent leading-[27.2px] overflow-hidden pb-[100%] md:text-[17px] md:leading-[28.9px]">
                    <a
                      href="https://foxiz.io/marketminds/blog/12-summer-outfit-formulas-for-lazy-girls-everywhere/"
            ...
            <div className="relative text-base box-border caret-transparent basis-full leading-[27.2px] max-w-[290px] min-h-[auto] min-w-[290px] w-full px-px md:text-[17px] md:basis-3/12 md:leading-[28.9px] md:max-w-none md:min-w-[auto] md:w-3/12">
              <div className="relative text-base bg-slate-950 box-border caret-transparent h-full leading-[27.2px] pb-[30px] md:text-[17px] md:leading-[28.9px]">
                <div className="relative text-base box-border caret-transparent leading-[27.2px] max-w-full z-10 mb-2.5 md:text-[17px] md:leading-[28.9px] md:mb-3">
                  <div className="relative text-base box-border caret-transparent leading-[27.2px] overflow-hidden pb-[100%] md:text-[17px] md:leading-[28.9px]">
                    <a
                      href="https://foxiz.io/marketminds/blog/closer-look-at-innovative-ventures-influencing-market-trends/"
                ...
                <h2 className="text-[19px] font-bold box-border caret-transparent tracking-[-0.55879px] leading-[24.7px] break-words mb-2.5 mx-[25px] font-plus_jakarta_sans md:text-[28px] md:tracking-[-0.82348px] md:leading-[35px] md:mb-3">
                  ...
                  >
                    {" "}
                    Closer Look at Innovative Ventures Influencing Market
                    Trends{" "}
                  </a>
                </h2>
                <div className="relative text-base box-border caret-transparent leading-[27.2px] mx-[25px] md:text-[17px] md:leading-[28.9px]">
            ...
            <div className="relative text-base box-border caret-transparent basis-full leading-[27.2px] max-w-[290px] min-h-[auto] min-w-[290px] w-full px-px md:text-[17px] md:basis-3/12 md:leading-[28.9px] md:max-w-none md:min-w-[auto] md:w-3/12">
              <div className="relative text-base bg-slate-950 box-border caret-transparent h-full leading-[27.2px] pb-[30px] md:text-[17px] md:leading-[28.9px]">
                <div className="relative text-base box-border caret-transparent leading-[27.2px] max-w-full z-10 mb-2.5 md:text-[17px] md:leading-[28.9px] md:mb-3">
                  <div className="relative text-base box-border caret-transparent leading-[27.2px] overflow-hidden pb-[100%] md:text-[17px] md:leading-[28.9px]">
                    <a
                      href="https://foxiz.io/marketminds/blog/hidden-ways-to-save-money-that-you-might-be-missing/"
